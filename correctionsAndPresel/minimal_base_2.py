...
class HggBaseProcessor(processor.ProcessorABC):  # type: ignore
    def __init__(
        ...
        self.use_photonid_mva = use_photonid_mva
        ...
        if self.use_photonid_mva:
            ...
            logger.info("Skipping PhotonID MVA loading (use_photonid_mva=False)")
            self.photonid_mva = None
    ...
    def process(self, events: awkward.Array) -> Dict[Any, Any]:
        ...
        # NOTE: `variations_combined` did not exist anywhere in the original file.
        # Best-guess reconstruction below - please verify against your true reference.
        ...
        for variation in variations:
            ...
            for i in range(4):
                pho = photons[:, i]
                df[f"pho{i+1}_energy"] = awkward.to_numpy(pho.energy) #explicitly calculated and added!
