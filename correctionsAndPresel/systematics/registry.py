...
weight_systematics = {
    ...
    ### Adding photon ID SFs for Haa
    "PhotonIdSFWP90": partial(photonSFs, sf_key="wp90", is_correction=False),
    "PhotonIdSFWP80": partial(photonSFs, sf_key="wp80", is_correction=False),
    "PhotonIdSFLoose": partial(photonSFs, sf_key="Loose", is_correction=False),
    "PhotonIdSFMedium": partial(photonSFs, sf_key="Medium", is_correction=False),
    "PhotonIdSFTight": partial(photonSFs, sf_key="Tight", is_correction=False),
    ###
...
weight_corrections = {
    ...
    ### Adding photon ID SFs for Haa
    "PhotonIdSFWP90": partial(photonSFs, sf_key="wp90", is_correction=True),
    "PhotonIdSFWP80": partial(photonSFs, sf_key="wp80", is_correction=True),
    "PhotonIdSFLoose": partial(photonSFs, sf_key="Loose", is_correction=True),
    "PhotonIdSFMedium": partial(photonSFs, sf_key="Medium", is_correction=True),
    "PhotonIdSFTight": partial(photonSFs, sf_key="Tight", is_correction=True),
    # SF for analyses requiring at least one lepton which can be e or mu
    # Choose combination of WPs for e and mu by name as in example below
    "atLeast1LeptonSF_eleRecoWP90iso_muIDMediumIsoTight": partial(
        atLeast1LeptonIdSF,
