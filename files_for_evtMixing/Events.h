...
// Mon Sep 15 14:55:37 2025 by ROOT version 6.32.02
// from TTree Events/Events
// found on file: 13a2e694-04f4-4ca6-a6fb-19c4db76a86a.root
//////////////////////////////////////////////////////////
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   Short_t         boostedTau_jetIdx[5];   //[nboostedTau]
   Short_t         boostedTau_rawAntiEleCat2018[5];   //[nboostedTau]
   ...
   Float_t         boostedTau_rawBoostedDeepTauRunIIv2p0VSe[5];   //[nboostedTau]
   Float_t         boostedTau_rawBoostedDeepTauRunIIv2p0VSjet[5];   //[nboostedTau]
   Float_t         boostedTau_rawBoostedDeepTauRunIIv2p0VSmu[5];   //[nboostedTau]
   ...
   Float_t         CorrT1METJet_muonSubtrDeltaEta[14];   //[nCorrT1METJet]
   Float_t         CorrT1METJet_muonSubtrDeltaPhi[14];   //[nCorrT1METJet]
   Float_t         CorrT1METJet_muonSubtrFactor[14];   //[nCorrT1METJet]
   Float_t         CorrT1METJet_phi[14];   //[nCorrT1METJet]
   Float_t         CorrT1METJet_rawMass[14];   //[nCorrT1METJet]
   ...
   Float_t         FatJet_globalParT3_QCD[5];   //[nFatJet]
   Float_t         FatJet_globalParT3_TopbWev[5];   //[nFatJet]
   Float_t         FatJet_globalParT3_TopbWmv[5];   //[nFatJet]
   Float_t         FatJet_globalParT3_TopbWq[5];   //[nFatJet]
   Float_t         FatJet_globalParT3_TopbWqq[5];   //[nFatJet]
   Float_t         FatJet_globalParT3_TopbWtauhv[5];   //[nFatJet]
   Float_t         FatJet_globalParT3_WvsQCD[5];   //[nFatJet]
   Float_t         FatJet_globalParT3_XWW3q[5];   //[nFatJet]
   Float_t         FatJet_globalParT3_XWW4q[5];   //[nFatJet]
   Float_t         FatJet_globalParT3_XWWqqev[5];   //[nFatJet]
   Float_t         FatJet_globalParT3_XWWqqmv[5];   //[nFatJet]
   Float_t         FatJet_globalParT3_Xbb[5];   //[nFatJet]
   Float_t         FatJet_globalParT3_Xcc[5];   //[nFatJet]
   Float_t         FatJet_globalParT3_Xcs[5];   //[nFatJet]
   Float_t         FatJet_globalParT3_Xqq[5];   //[nFatJet]
   Float_t         FatJet_globalParT3_Xtauhtaue[5];   //[nFatJet]
   Float_t         FatJet_globalParT3_Xtauhtauh[5];   //[nFatJet]
   Float_t         FatJet_globalParT3_Xtauhtaum[5];   //[nFatJet]
   Float_t         FatJet_globalParT3_massCorrGeneric[5];   //[nFatJet]
   Float_t         FatJet_globalParT3_massCorrX2p[5];   //[nFatJet]
   Float_t         FatJet_globalParT3_withMassTopvsQCD[5];   //[nFatJet]
   Float_t         FatJet_globalParT3_withMassWvsQCD[5];   //[nFatJet]
   Float_t         FatJet_globalParT3_withMassZvsQCD[5];   //[nFatJet]
   ...
   Float_t         FatJet_particleNetLegacy_QCD[5];   //[nFatJet]
   Float_t         FatJet_particleNetLegacy_Xbb[5];   //[nFatJet]
   Float_t         FatJet_particleNetLegacy_Xcc[5];   //[nFatJet]
   Float_t         FatJet_particleNetLegacy_Xqq[5];   //[nFatJet]
   Float_t         FatJet_particleNetLegacy_mass[5];   //[nFatJet]
   ...
   Int_t           nFatJetPFCand;
   Int_t           FatJetPFCand_pfCandIdx[221];   //[nFatJetPFCand]
   Int_t           FatJetPFCand_jetIdx[221];   //[nFatJetPFCand]
   Int_t           nFsrPhoton;
   ...
   Float_t         Jet_UParTAK4RegPtRawCorr[14];   //[nJet]
   Float_t         Jet_UParTAK4RegPtRawCorrNeutrino[14];   //[nJet]
   Float_t         Jet_UParTAK4RegPtRawRes[14];   //[nJet]
   Float_t         Jet_UParTAK4V1RegPtRawCorr[14];   //[nJet]
   Float_t         Jet_UParTAK4V1RegPtRawCorrNeutrino[14];   //[nJet]
   Float_t         Jet_UParTAK4V1RegPtRawRes[14];   //[nJet]
   ...
   Float_t         Jet_btagPNetCvNotB[14];   //[nJet]
   Float_t         Jet_btagPNetQvG[14];   //[nJet]
   Float_t         Jet_btagPNetTauVJet[14];   //[nJet]
   Float_t         Jet_btagUParTAK4B[14];   //[nJet]
   Float_t         Jet_btagUParTAK4CvB[14];   //[nJet]
   Float_t         Jet_btagUParTAK4CvL[14];   //[nJet]
   Float_t         Jet_btagUParTAK4CvNotB[14];   //[nJet]
   Float_t         Jet_btagUParTAK4Ele[14];   //[nJet]
   Float_t         Jet_btagUParTAK4Mu[14];   //[nJet]
   Float_t         Jet_btagUParTAK4QvG[14];   //[nJet]
   Float_t         Jet_btagUParTAK4SvCB[14];   //[nJet]
   Float_t         Jet_btagUParTAK4SvUDG[14];   //[nJet]
   Float_t         Jet_btagUParTAK4TauVJet[14];   //[nJet]
   Float_t         Jet_btagUParTAK4UDG[14];   //[nJet]
   Float_t         Jet_btagUParTAK4probb[14];   //[nJet]
   Float_t         Jet_btagUParTAK4probbb[14];   //[nJet]
   ...
   Float_t         Jet_muonSubtrDeltaEta[14];   //[nJet]
   Float_t         Jet_muonSubtrDeltaPhi[14];   //[nJet]
   ...
   UChar_t         Proton_multiRP_arm[13];   //[nProton_multiRP]
   Float_t         Proton_multiRP_t[13];   //[nProton_multiRP]
   Float_t         Proton_multiRP_thetaX[13];   //[nProton_multiRP]
   Float_t         Proton_multiRP_thetaY[13];   //[nProton_multiRP]
   Float_t         Proton_multiRP_time[13];   //[nProton_multiRP]
   Float_t         Proton_multiRP_timeUnc[13];   //[nProton_multiRP]
   Float_t         Proton_multiRP_xi[13];   //[nProton_multiRP]
   Int_t           nMuon;
   UChar_t         Muon_bestTrackType[13];   //[nMuon]
   ...
   Float_t         Muon_softMvaRun3[13];   //[nMuon]
   Float_t         Muon_tkRelIso[13];   //[nMuon]
   Float_t         Muon_tuneP_charge[13];   //[nMuon]
   Float_t         Muon_tuneP_pterr[13];   //[nMuon]
   Float_t         Muon_tunepRelPt[13];   //[nMuon]
   Float_t         Muon_bsConstrainedChi2[13];   //[nMuon]
   Float_t         Muon_bsConstrainedPt[13];   //[nMuon]
   Float_t         Muon_bsConstrainedPtErr[13];   //[nMuon]
   Float_t         Muon_mvaLowPt[13];   //[nMuon]
   Float_t         Muon_pnScore_heavy[13];   //[nMuon]
   Float_t         Muon_pnScore_light[13];   //[nMuon]
   Float_t         Muon_pnScore_prompt[13];   //[nMuon]
   Float_t         Muon_pnScore_tau[13];   //[nMuon]
   Float_t         Muon_promptMVA[13];   //[nMuon]
   Int_t           nPFCand;
   Int_t           PFCand_pdgId[221];   //[nPFCand]
   Float_t         PFCand_eta[221];   //[nPFCand]
   Float_t         PFCand_mass[221];   //[nPFCand]
   Float_t         PFCand_phi[221];   //[nPFCand]
   Float_t         PFCand_pt[221];   //[nPFCand]
   Float_t         PFMET_covXX;
   Float_t         PFMET_covXY;
   Float_t         PFMET_covYY;
   Float_t         PFMET_phi;
   ...
   Int_t           PPSLocalTrack_multiRPProtonIdx[34];   //[nPPSLocalTrack]
   Int_t           PPSLocalTrack_singleRPProtonIdx[34];   //[nPPSLocalTrack]
   Int_t           PPSLocalTrack_decRPId[34];   //[nPPSLocalTrack]
   Int_t           PPSLocalTrack_rpType[34];   //[nPPSLocalTrack]
   Float_t         PPSLocalTrack_x[34];   //[nPPSLocalTrack]
   Float_t         PPSLocalTrack_y[34];   //[nPPSLocalTrack]
   Float_t         PPSLocalTrack_time[34];   //[nPPSLocalTrack]
   Float_t         PPSLocalTrack_timeUnc[34];   //[nPPSLocalTrack]
   ...
   Int_t           nTauProd;
   Short_t         TauProd_tauIdx[25];   //[nTauProd]
   Int_t           TauProd_pdgId[25];   //[nTauProd]
   Float_t         TauProd_eta[25];   //[nTauProd]
   Float_t         TauProd_phi[25];   //[nTauProd]
   Float_t         TauProd_pt[25];   //[nTauProd]
   Int_t           nTau;
   ...
   Short_t         Tau_decayModeUParT[5];   //[nTau]
   ...
   Float_t         Tau_rawUParTVSe[5];   //[nTau]
   Float_t         Tau_rawUParTVSjet[5];   //[nTau]
   Float_t         Tau_rawUParTVSmu[5];   //[nTau]
   Int_t           nTrigObj;
   Short_t         TrigObj_l1charge[101];   //[nTrigObj]
   UShort_t        TrigObj_id[101];   //[nTrigObj]
   Int_t           TrigObj_l1iso[101];   //[nTrigObj]
   ULong64_t       TrigObj_filterBits[101];   //[nTrigObj]
   Float_t         TrigObj_pt[101];   //[nTrigObj]
   Float_t         TrigObj_eta[101];   //[nTrigObj]
   Float_t         TrigObj_phi[101];   //[nTrigObj]
   Float_t         TrigObj_l1pt[101];   //[nTrigObj]
   Float_t         TrigObj_l1pt_2[101];   //[nTrigObj]
   Float_t         TrigObj_l2pt[101];   //[nTrigObj]
   Float_t         TrkMET_phi;
   Float_t         TrkMET_pt;
   ...
   Float_t         Muon_IPx[13];   //[nMuon]
   Float_t         Muon_IPy[13];   //[nMuon]
   Float_t         Muon_IPz[13];   //[nMuon]
   Float_t         Muon_ipLengthSig[13];   //[nMuon]
   ...
   Float_t         SV_y[13];   //[nSV]
   Float_t         SV_z[13];   //[nSV]
   Bool_t          Tau_hasRefitSV[5];   //[nTau]
   Float_t         Tau_IPx[5];   //[nTau]
   Float_t         Tau_IPy[5];   //[nTau]
   Float_t         Tau_IPz[5];   //[nTau]
   Float_t         Tau_ipLengthSig[5];   //[nTau]
   Float_t         Tau_refitSVchi2[5];   //[nTau]
   Float_t         Tau_refitSVcov00[5];   //[nTau]
   Float_t         Tau_refitSVcov10[5];   //[nTau]
   Float_t         Tau_refitSVcov11[5];   //[nTau]
   Float_t         Tau_refitSVcov20[5];   //[nTau]
   Float_t         Tau_refitSVcov21[5];   //[nTau]
   Float_t         Tau_refitSVcov22[5];   //[nTau]
   Float_t         Tau_refitSVx[5];   //[nTau]
   Float_t         Tau_refitSVy[5];   //[nTau]
   Float_t         Tau_refitSVz[5];   //[nTau]
   ...
   Bool_t          L1_MHT120_pRECO;
   Bool_t          L1_MHT150_pRECO;
   Bool_t          L1_MHT200_pRECO;
   ...
   TBranch        *b_L1_MHT120_pRECO;   //!
   TBranch        *b_L1_MHT150_pRECO;   //!
   TBranch        *b_L1_MHT200_pRECO;   //!
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("13a2e694-04f4-4ca6-a6fb-19c4db76a86a.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("13a2e694-04f4-4ca6-a6fb-19c4db76a86a.root");
      }
...
void Events::Init(TTree *tree)
{
   ...
   fChain->SetBranchAddress("L1_MHT120", &L1_MHT120, &b_L1_MHT120);
   fChain->SetBranchAddress("L1_MHT150", &L1_MHT150, &b_L1_MHT150);
   fChain->SetBranchAddress("L1_MHT200", &L1_MHT200, &b_L1_MHT200);
   ...
   fChain->SetBranchAddress("L1_MHT120_pRECO", &L1_MHT120_pRECO, &b_L1_MHT120_pRECO);
   fChain->SetBranchAddress("L1_MHT150_pRECO", &L1_MHT150_pRECO, &b_L1_MHT150_pRECO);
   fChain->SetBranchAddress("L1_MHT200_pRECO", &L1_MHT200_pRECO, &b_L1_MHT200_pRECO);
